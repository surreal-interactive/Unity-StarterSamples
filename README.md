...
After that, it's recommended to try Surreal VR SDK following [Step-by-Step instruction](https://github.com/surreal-interactive/SDK/blob/master/README.md) by creating a brand new scene under this project.
